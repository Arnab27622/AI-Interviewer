...
const SessionReviewStats: React.FC<SessionReviewStatsProps> = ({
    ...
    return (
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {stats.map((stat, i) => (
                <div key={i} className="glass-card p-5 sm:p-8 rounded-3xl sm:rounded-[2.5rem] border-l-4 border-l-primary-500 relative overflow-hidden group hover:border-l-primary-400 transition-all duration-500">
